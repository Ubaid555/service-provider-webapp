...
export default function AboutAddress() {
  ...
  return (
    <div>
      <address className="address">{t("address.addressText")}</address>

      <div className="responsive-map">
        <iframe
          title="Google Maps Embed"
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3320.4772626862105!
        ...
        Territory%2C%20Pakistan!5e0!3m2!1sen!2s!4v1708492106800!5m2!1sen!2s"
          width="1690"
          height="300"
          style={{ border: 0 }}
          allowFullScreen=""
