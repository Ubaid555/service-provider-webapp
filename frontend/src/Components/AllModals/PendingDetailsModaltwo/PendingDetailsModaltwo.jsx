...
import styles from './PendingDetailsModaltwo.module.css';

const PendingDetailsModaltwo = ({ booking, onClose }) => {
    useEffect(() => {
...
export default PendingDetailsModaltwo;