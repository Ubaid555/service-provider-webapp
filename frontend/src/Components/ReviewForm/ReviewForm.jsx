...
const ReviewForm = () => {
    const location = useLocation();
    const { booking } = location.state || {}; // Default to an empty object if location.state is undefined
    ...
    // Conditional rendering based on booking
    if (!booking) {
        return null; // or show a loading spinner, error message, or redirect
    }
