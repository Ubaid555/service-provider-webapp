...
export const Signup = () => {
    ...
    useEffect(() => {
        // Apply RTL direction when the language is Urdu
    ...
    return (
        <>
            <Navbar />
            <TranslateButton />
            <div className={`${styles.whole_content} ${i18n.language === 'ur' ? styles.rtl : ''}`}>
                <div className={styles.signupContainer}>
                    <div className={styles.register}>
                        {step === 1 && (
                            <>
                                ...
                                <div className={styles.inputs}>
                                    ...
                                    <div className={`${styles.input} ${i18n.language === 'ur' ? styles.rtlInput : ''}`}>
                                        <img src={password_icon} alt="password-img" className={styles.inputImg} />
                                        <input
                                            type={showPassword ? "text" : "password"}
                                            value={password}
                                    ...
                                    <div className={`${styles.input} ${i18n.language === 'ur' ? styles.rtlInput : ''}`}>
                                        ...
                                        />
                                        <i
                                            className={`fa ${showConfirmPassword ? "fa-eye-slash" : "fa-eye"} ${styles.eyeIcon} ${i18n.language === 'ur' ? styles.rtlIcon : ''}`}
                                            onClick={toggleConfirmPasswordVisibility}
                                        ></i>
                                    </div>
                                    <div className={styles.file}>
                                ...
                                <NavLink onClick={collectData} className={styles.appButton}>{t('signUp')}</NavLink>
                            </>
                        )}
                        {step === 2 && (
                            <>
                                ...
                                <NavLink onClick={verifyOtp} className={styles.verifyButton}>{t('verifyOtp')}</NavLink>
                            </>
                        )}
                    </div>
                </div>
