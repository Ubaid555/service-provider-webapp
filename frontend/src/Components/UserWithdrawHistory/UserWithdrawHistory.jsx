...
// import styles from './UserWithdrawHistory.module.css'; // Make sure to create this CSS module
...
//             try {
//                 const response = await fetch(`http://localhost:5001/api/payment/withdrawHistory?userId=${userId}`, {
//                     method: 'GET',
//                     headers: {
...
//                                         <td className={styles.tableCell}>{withdrawal.amountToWithdraw}</td>
//                                         <td className={styles.tableCell}>{withdrawal.accountNumber}</td>
//                                         <td className={styles.tableCell}>{withdrawal.withdrawMethod}</td>
//                                         <td className={styles.tableCell}>{new Date(withdrawal.updatedAt).toLocaleDateString()}</td>
//                                     </tr>
//                                 ))
//                             ) : (
//                                 <tr className={styles.tableRow}>
//                                     <td colSpan="5" className={styles.noBookings}>No withdrawal history found.</td>
//                                 </tr>
//                             )}
//                         </tbody>
//                     </table>
...
const UserWithdrawHistory = () => {
    ...
    const filteredWithdrawHistory = selectedDate
        ? withdrawHistory.filter((withdrawal) => {
            const withdrawalDate = new Date(withdrawal.updatedAt).toISOString().split('T')[0];
        ...
        <>
            ...
            <ChatBox />
                ...
                <div className={styles.filterContainer}>
                    <label htmlFor="dateFilter" className={styles.dateLabel}>Search by date:</label>
                    <input
                        type="date"
                        id="dateFilter"
