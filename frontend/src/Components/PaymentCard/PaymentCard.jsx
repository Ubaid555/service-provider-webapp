...
const PaymentCard = ({
  ...
  const cardNumberPlaceholder = cardNumber
    ? formattedCardNumber
    : "**** **** **** ****";
        ...
        <div className={`${styles.card} ${styles.back}`}>
          <div>
            <div className={styles.num}>
              For Customer Service - Call at 0302-9428807{" "}
            </div>
          </div>
          ...
          <div>
            <div className={styles.paraText}>
              For security purposes, please ensure that you are the only
              individual to have access to this card. Protect your card details
              and personal identification number (PIN) at all times. Never
              disclose your PIN to anyone, including bank representatives.
            </div>
          </div>
        </div>
      </ReactCardFlip>
